...
class PatientManage(models.Model):
    ...
    patient_ecg = models.FileField(verbose_name="心电记录", null=True,blank=True, upload_to='static/patient/%Y/%m/%d/')
    diagnosis_result = models.TextField(verbose_name="诊断结果", blank=True, null=True)
